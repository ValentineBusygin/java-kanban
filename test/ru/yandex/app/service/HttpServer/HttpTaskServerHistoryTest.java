...
public class HttpTaskServerHistoryTest extends HttpTaskServerTest {
    ...
    public void testGetHistory() throws IOException, InterruptedException {
        ...
        subTask = new SubTask(3, "SubTaskTwo", "SubTaskOneDescription", TaskState.NEW, LocalDateTime.now().plusMinutes(30), Duration.ofMinutes(10), 1);
        manager.addSubTask(subTask);
        ...
        Task resultTask = gson.fromJson(tasks[1], Task.class);
        assertEquals(4, resultTask.getTaskID(), "Вторым должен идти таск 4");

        resultSubTask = gson.fromJson(tasks[2], SubTask.class);
        assertEquals(2, resultSubTask.getTaskID(), "Третьим должен идти сабтаск 2");
    }
}
